...
export const TAMANHOS = { ANO: 4, TELEFONE: 12, CPF: 13, MAX_LINHAS_TABELA: 10, SENHA: 15 };
export const TEMA_PADRAO = "bluegray";
export function estilizarBotao() {
    const cor_botao = "green";
...
export function estilizarInputText(erro, input_classname, cor_tema = TEMA_PADRAO) {
    let cor_borda = `border-${cor_tema}-800`;
    if (erro) cor_borda = "p-invalid";
